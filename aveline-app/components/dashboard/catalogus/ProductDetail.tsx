  ...
  return (
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="flex-1 overflow-y-auto pb-32">
        {/* Hero */}
        <div className="mx-5 mt-5 mb-5 rounded-2xl flex items-center justify-center text-6xl"
          style={{ background: "#EFF5EE", height: 160 }}
        >
          🍫
        </div>
      ...
      >
        ...
        <button
          onClick={() =>
            router.push(
              `/dashboard/orders/nieuw?productId=${product.id}&productNaam=${encodeURIComponent(product.name)}`
            )
          }
